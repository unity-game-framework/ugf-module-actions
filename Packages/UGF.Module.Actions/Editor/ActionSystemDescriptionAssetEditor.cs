...
{
    [CustomEditor(typeof(ActionSystemDescriptionAsset), true)]
    internal class ActionSystemDescriptionAssetEditor : UnityEditor.Editor
    {
        private SerializedProperty m_propertyScript;
        private SerializedProperty m_propertyGroup;
        private AssetReferenceListDrawer m_listActions;

        private void OnEnable()
        {
            m_propertyScript = serializedObject.FindProperty("m_Script");
            m_propertyGroup = serializedObject.FindProperty("m_group");
            m_listActions = new AssetReferenceListDrawer(serializedObject.FindProperty("m_actions"));
